...
function runEverything() {
    ...
    function lingerify(e){
        var ot = e.offset().top;
        var ol = e.offset().left;
        console.log(ot, ol);
        jQuery('body').append(e.clone().css('left', ot).css('top', ol).css('opacity', 1).attr('id', 'tempElementThing'));
        setTimeout(function(){
            console.log(ot, ol);
